...
{
    public sealed partial class OniSystem : SharedOniSystem
    {
        ...
        private void OnEntInserted(EntityUid uid, OniComponent component, EntInsertedIntoContainerMessage args)
        {
            ...
            if (TryComp<ToolComponent>(args.Entity, out var tool) && _toolSystem.HasQuality(args.Entity, PryingQuality, tool))
