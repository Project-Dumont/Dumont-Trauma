...
marking-VulpTailCoyoteAnimated = Coyote (Animated)
marking-VulpTailFennecAnimated = Fennec (Animated)
marking-VulpTailFluffyAnimated = Fluffy (Animated)
marking-VulpTailHuskyAnimated = Husky (Animated)
marking-VulpTailLongAnimated = Long (Animated)
marking-VulpTailVulpAnimated = Vulp (Animated)
marking-VulpTailVulpFadeAnimated = Vulp Fade (Animated)
