...
marking-VoxTailAnimated = Default (Animated)
marking-VoxTailBigAnimated = Big (Animated)
marking-VoxTailDockedAnimated = Docked (Animated)
marking-VoxTailShortAnimated = Short (Animated)
marking-VoxTailSpikesAnimated = Spikes (Animated)
marking-VoxTailSplitAnimated = Split (Animated)
