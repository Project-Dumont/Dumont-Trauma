...
marking-LizardTailAquaticAnimated = Aquatic (Animated)
marking-LizardTailDTigerAnimated = D Tiger (Animated)
marking-LizardTailLTigerAnimated = L Tiger (Animated)
marking-LizardTailLargeAnimated = Large (Animated)
marking-LizardTailSmoothAnimated = Smooth (Animated)
marking-LizardTailSpikesAnimated = Spikes (Animated)
marking-SnakeLargeTailAnimated = Default (Animated)
marking-TailDroppedAnimated = Default (Animated)
